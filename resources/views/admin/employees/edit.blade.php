        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">Edit Employee Details</h3>
                </div>
                <div class="panel-body">
                    
                    @include('flash::message')

                    {{ Form::model($employee,['route' => ['admin.employees.update',$domain,$employee->id],'role'=>'form','method' => 'PUT']) }}
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-12 col-xs-6">
                                        {{ Form::submit('Change Details',['class'=>'btn btn-sm btn-success']) }}
                                    </div>
                                </div>
                            </div>
                        </fieldset>
